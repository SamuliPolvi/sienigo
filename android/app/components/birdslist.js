...
export default class BirdsList extends Component {
  ...
  render() {
    ...
    return (
        <List dataArray={this.props.birds} renderRow={(item) =>
            <Content>
            ...
            <Content>
                ...
                <Text selectable style={{marginLeft: 18, marginBottom: 18, color: '#fff'}}>
                    <Text style={{color: '#fff', fontWeight: 'bold'}}>Esiintyminen:</Text> {item.levinneisyys}</Text>
                <Text selectable  style={{marginLeft: 18, marginBottom: 18, color: '#fff'}}>
                    <Text style={{color: '#fff', fontWeight: 'bold'}}>Uhanalaisuus:</Text> {item.endanger}</Text>
                </Content>}    
            </Content>
        }>
        </List>
